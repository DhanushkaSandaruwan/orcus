  ...
  return (
    <div className="flex flex-col py-19 px-[20px] lg:px-[50px] items-center gap-[41px] border border-[rgba(255,255,255,0.15)] bg-gradient-to-br from-[#FE2C5E] to-[#020103] min-w-screen overflow-auto">
      <button className="cursor-pointer text-nowrap flex flex-col justify-center items-center gap-[31px] w-fit">
        <p className="flex flex-col justify-center text-[#FFF] font-inter text-4xl sm:text-[56px] font-medium leading-[1.1em] sm:leading-[1.16071em] w-full max-w-[289px] h-12 text-center tracking-[-0.015em]">
          FAQs
        </p>
      </button>
      ...
      <div className="flex max-w-[1280px] flex-col items-start gap-5 w-full">
        {faqData.map((item, i) => (
          ...
          >
            ...
            >
              <p className="text-[#FFF] font-montserrat text-lg sm:text-[22px] font-semibold leading-[1.3em] sm:leading-[1.36em] text-center">
                {item.question}
              </p>
      ...
      <div className="mt-4">
        ...
        >
          <span className="text-[#000] font-inter text-[15px] font-medium leading-[2.06667em] w-fit tracking-[-0.0101em]">
            See all
          </span>
        </a>
      </div>
