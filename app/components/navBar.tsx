...
export default function Navm() {
  return (
    <nav className="w-full h-20 border-b border-white/20 flex items-center justify-between px-10">
      {/* Left: Logo */}
      ...
      {/* Center: Menu */}
      <div className="flex items-center gap-7 px-10 py-2 rounded-[60px] outline outline-1 outline-white/20">
      ...
      <div className="p-1.5 rounded-xl outline outline-1 outline-white/20 backdrop-blur-sm">
        <button className="w-28 h-7 px-3.5 py-0.5 bg-rose-500 rounded-lg shadow-[inset_0px_0px_6px_3px_rgba(255,255,255,0.25)] outline outline-1 outline-white/20 flex items-center justify-center">
