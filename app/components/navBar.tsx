...
export default function Navm() {
    ...
    return (
        <nav
            className="sticky top-0 z-50 bg-black/70 w-full h-20 border-b border-white/20 flex items-center justify-between px-[20px] lg:px-10">
            {/* Left: Logo */}
            ...
            <div className="flex w-full justify-between">
                ...
                <button className="lg:hidden text-white ms-[10px]" onClick={() => setOpen(!open)}>
                    <MobileMenuIcon/>
                </button>
            </div>
        </nav>
