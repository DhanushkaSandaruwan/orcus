export default function Frame39() {
    ...
    return (
        <div id="solutions" className="flex flex-col items-center gap-[70px] pb-20 pt-0 min-w-screen w-full bg-[#000] px-[50px]">
            {/* === Top Row (3 Cards) === */}
            <div className="grid grid-flow-col grid-cols-1 grid-rows-3 lg:grid-rows-1 lg:grid-cols-3 w-full max-w-[1280] gap-x-[20px] gap-y-[70px] justify-center">
                {topCards.map((card, i) => (
                    <div
                        key={i}
            ...
            <div className="grid grid-flow-col grid-cols-1 grid-rows-2 lg:grid-rows-1 lg:grid-cols-2 w-full max-w-[1100] gap-x-[20px] gap-y-[70px] justify-center">
                {bottomCards.map((card, i) => (
                    <div
                        key={i}
                        className="relative min-h-[260px] rounded-[20px] p-[2px] grid
                                      bg-gradient-to-br from-[#FFFFFF] to-[#FE2C5E]
                                      w-full max-w-full lg:max-w-full"
                    >
                        <div
                            className="flex flex-col justify-center items-center text-center p-[50px] h-full rounded-[18px] bg-[#000]">
                            <p className="text-[#FFF] font-montserrat text-[25px] font-semibold leading-[1.4em]">
