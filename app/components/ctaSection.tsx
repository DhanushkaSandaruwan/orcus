...
export default function CtaSection() {
  ...
  return (
    <div className="relative w-full h-[473px] overflow-hidden">
  ...
  style={{
    background:
      "radial-gradient(ellipse 100% 80% at 50% -10%, #FE2C5E 0%, rgba(254,44,94,0.25) 50%, transparent 90%)",
...
/>
      ...
      <div
        ref={ref}
        className={`absolute inset-0 flex flex-col justify-center items-center gap-6 -translate-y-10 transition-all duration-700
          ${inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
      >
        {/* Title */}
        <h1 className="text-white font-inter text-[56px] font-medium leading-[1.16] text-center tracking-[-0.015em] transition-transform duration-500 hover:scale-[1.02]">
          Join the Waitlist
        </h1>

        {/* Form */}
        <div className="flex py-[19px] px-4 items-center gap-2.5 rounded-lg border border-[rgba(255,255,255,0.15)] min-w-3/12 overflow-auto relative transition-transform duration-300 hover:scale-[1.02]">
          <input
            type="email"
