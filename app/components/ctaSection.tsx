          ...
          ${inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
            >
                ...
                <div className="flex flex-col gap-[10px]">
                    <div
                        className="flex py-[19px] px-4 items-center gap-2.5 rounded-lg border border-[rgba(255,255,255,0.15)] min-w-[300px] w-full max-w-[400px] overflow-auto relative transition-transform duration-300 hover:scale-[1.02]">
                        <input
                            type="email"
