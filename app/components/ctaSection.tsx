        ...
        <div className="relative w-full h-[473px] overflow-hidden">
          ...
          ${inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
            >
                ...
                {/* Form */}
                <div
                    className="flex py-[19px] px-4 items-center gap-2.5 rounded-lg border border-[rgba(255,255,255,0.15)] min-w-3/12 overflow-auto relative transition-transform duration-300 hover:scale-[1.02]">
                    <input
                        type="email"
